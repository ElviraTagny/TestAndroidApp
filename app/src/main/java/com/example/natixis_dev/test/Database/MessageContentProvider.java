...
public class MessageContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.example.natixis_dev.test.contentprovider";
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        // Set the table
        queryBuilder.setTables(MessageDatabaseHelper.TABLE_MESSAGE);
        ...
        switch (uriType) {
            ...
            case MESSAGE_ID:
                ...
                queryBuilder.appendWhere(MessageDatabaseHelper.COLUMN_ID + "="
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriType) {
            case MESSAGES:
                id = sqlDB.insert(MessageDatabaseHelper.TABLE_MESSAGE, null, values);
                break;
            default:
                throw new IllegalArgumentException("Unknown URI: " + uri);
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriType) {
            case MESSAGES:
                rowsDeleted = sqlDB.delete(MessageDatabaseHelper.TABLE_MESSAGE, selection,
                        selectionArgs);
                break;
            case MESSAGE_ID:
                ...
                if (TextUtils.isEmpty(selection)) {
                    rowsDeleted = sqlDB.delete(
                            MessageDatabaseHelper.TABLE_MESSAGE,
                            MessageDatabaseHelper.COLUMN_ID + "=" + id,
                            null);
                } else {
                    rowsDeleted = sqlDB.delete(
                            MessageDatabaseHelper.TABLE_MESSAGE,
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        switch (uriType) {
            case MESSAGES:
                rowsUpdated = sqlDB.update(MessageDatabaseHelper.TABLE_MESSAGE,
                        values,
                        selection,
                        selectionArgs);
                break;
